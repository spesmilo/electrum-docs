...
# note(ghost43): the documentation is often for the master branch.
#                TODO we should have at least two branches of the docs:
#                     one for the latest release, and one for master.
#                In any case, what version of "Electrum" shall we put here?
release = "4"
